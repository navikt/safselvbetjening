...
public enum ErrorCode {
    ...
    public static final String FEILMELDING_TOKEN_MISMATCH_INGEN_REPRESENTASJON = "Innlogget brukers ident i token matcher ikke ident i query. Innlogget bruker har heller ingen representasjon overfor ident i query.";
