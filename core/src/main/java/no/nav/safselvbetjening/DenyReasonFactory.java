...
public class DenyReasonFactory {
	...
	public static final String FEILMELDING_BRUKER_MATCHER_IKKE_TOKEN = "Bruker på journalpost tilhører ikke bruker i token. Innlogget bruker har heller ingen representasjon overfor journalpost tilhørende bruker.";
	...
	public static String medGrunn(TilgangDenyReason reason) {
		return switch (reason) {
			case DENY_REASON_IKKE_AVSENDER_MOTTAKER -> FEILMELDING_ANNEN_PART;
			case DENY_REASON_FOER_INNSYNSDATO -> FEILMELDING_INNSYNSDATO;
