...
class DokumentoversiktAuditTest {
	...
	@Test
	void shouldMapDokumentoversiktAuditLogAsVerge() {
		MDC.put(MDC_CONSUMER_ID, "itest:teamdokumenthandtering:audit");
		MDC.put(MDC_CALL_ID, "1234-5678-9101");

		Vergemaal vergemaal = new Vergemaal(REPRESENTANT, REPRESENTERT, new LinkedHashSet<>(List.of("BAR", "FOR")));

		CommonEventFormat commonEventFormat = audit.mapDokumentoversikt(vergemaal);
		assertThat(commonEventFormat.toString())
				.isEqualTo("CEF:0|safselvbetjening|AuditLog|1.0|audit:access|brukers dokumentoversikt hentet av verge|INFO|" +
						...
						"duid=11111111111 act=dokumentoversikt_vergemaal");
	}
