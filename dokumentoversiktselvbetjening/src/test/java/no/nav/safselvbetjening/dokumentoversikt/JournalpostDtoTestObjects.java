...
import no.nav.safselvbetjening.consumer.dokarkiv.domain.AvsenderMottakerIdTypeCode;
import no.nav.safselvbetjening.consumer.dokarkiv.domain.BrukerDto;
import no.nav.safselvbetjening.consumer.dokarkiv.domain.DokumentInfoDto;
import no.nav.safselvbetjening.consumer.dokarkiv.domain.DokumentKategoriCode;
...
import no.nav.safselvbetjening.consumer.dokarkiv.domain.LogiskVedleggDto;
...
import no.nav.safselvbetjening.consumer.dokarkiv.domain.TilleggsopplysningDto;
